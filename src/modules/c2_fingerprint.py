...
class FeodoMonitor:
    """Polls psutil.net_connections() every N seconds."""
...
class DgaMonitor:
    """Analyses queried domain names for DGA (Domain Generation Algorithm) characteristics using Shannon entropy."""
...
class Ja3Monitor:
    """Sniffs TLS traffic on port 443/8443 via scapy, computes JA3 fingerprints, and alerts when a fingerprint matches the abuse.ch SSLBL blocklist."""
