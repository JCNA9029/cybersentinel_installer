...
class BaselineEngine:
    """Two operating modes: LEARN — silently records every running process + its network destinations for BASELINE_HOURS, then writes a behavioral profile to SQLite."""
